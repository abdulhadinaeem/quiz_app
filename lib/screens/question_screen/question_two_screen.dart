        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Center(
                child: Text(
                  provider.questionModelList[1].question,
            ...
            Container(
              ...
              child: Column(
                children: [
                  for (int i = 0;
                      i < provider.questionModelList[1].optionsList.length;
                      i++)
                    GestureDetector(
                      //onTap..........................
                      onTap: () {
                        if (!isSelected) {
                          setState(() {
                            ...
                            selectedIndex = i;
                            selectedIndex == i
                                ? provider.questionModelList[1].optionsList[i]
                                        .isCorrect
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              provider
                                  .questionModelList[1].optionsList[i].options,
                            ),
                            selectedIndex == i
                                ? provider.questionModelList[1].optionsList[i]
                                        .isCorrect
            ...
            isSelected
                ? MaterialButton(
                    ...
                    onPressed: () {
                      Navigator.pushReplacementNamed(
                        context,
                        RouteNames.questionThreeScreen,
                      );
                    },
                    child: Text(
                      AppText.next,
                ...
                : CircleAvatar(
                    ...
                    child: CustomCountDown(
                      ...
                      routeName: RouteNames.questionThreeScreen,
                      onFinished: () {
                        Navigator.pushReplacementNamed(
                          context,
                          RouteNames.questionThreeScreen,
